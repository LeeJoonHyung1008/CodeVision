...
_0x0:
	.DB  0x43,0x45,0x4E,0x54,0x45,0x52,0x20,0x3A
	.DB  0x20,0x25,0x64,0x20,0x4C,0x45,0x46,0x54
	.DB  0x20,0x3A,0x20,0x25,0x64,0x20,0x52,0x49
	.DB  0x47,0x48,0x54,0x20,0x3A,0x20,0x25,0x64
	.DB  0xD,0xA,0x0
...
; 0002 000B unsigned char getchar(void){
; 0002 000C     while((UCSR1A & RX_COMPLETE)==0);
; 0002 000D     return UDR1;
; 0002 000E }
	#ifndef __SLEEP_DEFINED__
	#define __SLEEP_DEFINED__
	.EQU __se_bit=0x20
